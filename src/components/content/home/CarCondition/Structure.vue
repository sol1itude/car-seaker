<template>
    <Card>
        <div class="d-flex al-center jc-between car-head">
            <h1 class="title">{{title}} {{constructAnalyzeRepairRecords.length}}</h1>
        </div>
        <div class="card-cont">
            <div class="maintenance-list">
                <div class="maintenance-item" v-for="(item, index) in constructAnalyzeRepairRecords" :key="index">
                    ...
                    <div class="m-center d-flex">
                        <p class="tt hl">项目</p>
                        <b class="cc">{{item.content}}</b>
                    </div>
                    <div class="m-bottom d-flex">
                        <p class="tt hl">材料</p>
                        <p class="cc">{{item.materal}}</p>
                    </div>
                </div>
            </div>
        </div>
...
export default {
    ...
    props: {
        ...
        constructAnalyzeRepairRecords: Array
    }
}
</script>
